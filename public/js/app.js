...
function updateCart(makeups) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', makeups).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var makeups = JSON.parse(btn.dataset.products);
    updateCart(makeups);
  });
});
...
__webpack_require__(/*! C:\Users\DCL\realtime makeup shop\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\DCL\realtime makeup shop\resources\scss\app.scss */"./resources/scss/app.scss");
